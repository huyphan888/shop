        ...
        <div class="col-12">
            <div class="card mb-3">
                ...
                <div class="card-header">
                    ...
                    <h3><i class="fa fa-comment"></i> All comments ({{$comments->total()}} comments)</h3>
                </div>
                <!-- end card-header -->
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tr @if(!$comment->is_active) style="background-color:#ccc" @endif>
                                ...
                                <td>
                                    <span style="float: left; margin-right:10px;">
                                        <a href="{{route('comments.edit',$comment->id)}}"><img style="height:70px;" src="{{$comment->photo?asset($comment->photo):'http://placehold.it/120x70'}}"/></a>
                                    </span>
                            ...
                            <td>{{str_limit($comment->content,30)}}</td>
                                ...
                                <td><a class="btn btn-outline-warning" href="{{route('frontend.detail',[$comment->product->cate->slug,str_slug($comment->product->name),$comment->product->id])}}">Link</a></td>
